...
(Point.interpolate = function (t, e, n) {
    ...
    (Maths.lineIntersectLine2 = function (t, e, n, r) {
        ...
        return (
            ...
            (__c = new Point(y.x * x + y.y * a, y.y * x - y.x * a)),
            (__d = new Point(f.x * x + f.y * a, f.y * x - f.x * a)),
            (__c.y < 0 && __d.y < 0) ||
            (__c.y >= 0 && __d.y >= 0) ||
            (u = Maths.fixNumber(__d.x + ((__c.x - __d.x) * __d.y) / (__d.y - __c.y))) < 0 ||
            u > i
                ? null
                : new Point(t.x + u * x, t.y + u * a)
        );
    }),
            ...
            (f < 0 || f > 1) && (o < 0 || o > 1)
                ...
                : (0 <= o &&
                  ...
                  0 <= f &&
                      ...
                      (i.exit = new Point(Maths.fixNumber(i.exit.x), Maths.fixNumber(i.exit.y)))),
                  (i.intersects = !0),
                  null != i.exit && null != i.enter && i.exit.equals(i.enter) && (i.tangent = !0));
        }
        return i;
    }),
