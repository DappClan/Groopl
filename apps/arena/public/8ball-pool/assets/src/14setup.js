...
(playState.init = function () {
    ...
    (playState.create = function () {
                    ...
                    (e.landscape = !1),
                        ...
                        projectInfo.tutorial &&
                            ...
                            game.device.touch &&
                                ...
                                (6 != e.tutStage && 7 != e.tutStage) ||
                                    ((e.hand.x = e.pointerStart.x), (e.hand.y = e.pointerStart.y)),
                                e.tutStage >= 8 &&
                        ...
                        (e.menuButton.y = 10),
                        (e.menuButton.scale = new Point(0.35, 0.35)),
                        game.device.touch &&
                            ((e.powerBar.angle = -90),
                            (e.powerBar.x = 60),
                        ...
                        (e.successIcon.angle = 90),
                        (e.gameOverPanel.x = game.width / 2 + 35),
                        (e.gameOverPanel.y = game.height / 2),
                        (e.gameOverPanelBG.angle = -90),
                        (e.GOhighScoreIcon.x = 80),
                        (e.GOhighScoreIcon.y = -346),
                        (e.gameOverPanel.text2.x = 145),
                        (e.gameOverPanel.text2.y = -349),
                        (e.playerWin.x = -240),
                        (e.playerWin.y = -405),
                        (e.popUpPanel.x = game.width / 2 + 25),
                        (e.popUpPanel.y = game.height / 2),
                        (e.popUpPanelBG.angle = 0);
                    let a = famobi.hasFeature("external_mute");
                    (e.playButtonPU.x = 0),
                        (e.playButtonPU.y = -90),
                        (e.muteButtonPU.x = -170),
                        (e.muteButtonPU.y = 130),
                        (e.replayButtonPU.x = a ? -85 : 0),
                        (e.replayButtonPU.y = 130),
                        (e.quitButtonPU.x = a ? 85 : 170),
                        (e.quitButtonPU.y = 130),
                        (e.humanIcon.x = 170),
                        (e.humanIcon.y = game.height - 95),
                        (e.humanIcon.scale = new Point(0.35, 0.35)),
                        (e.aiIcon.x = 170),
                        (e.aiIcon.y = game.height - 0),
                        (e.aiIcon.anchor = new Point(0, 1)),
                        (e.aiIcon.scale = new Point(0.35, 0.35)),
                        (e.turnArrow1.x = 125),
                        (e.turnArrow1.scale = new Point(0.5, 0.5)),
                        (e.turnArrow1.y = game.height - 110),
                        (e.turnArrow2.x = 125),
                        (e.turnArrow2.scale = new Point(0.5, 0.5)),
                        ...
                        "SOLIDS" == e.p1TargetType &&
                            ((e.rackStripes.y = game.height - 10), (e.rackSolids.y = game.height - 100)),
                        "STRIPES" == e.p1TargetType &&
                            ((e.rackSolids.y = game.height - 10), (e.rackStripes.y = game.height - 100)),
                        (e.spinSetter.x = game.width - 135),
                        (e.spinSetter.y = game.height - 105),
                        (e.spinSetterZoom.x = game.width / 2 + 30),
                        (e.spinSetterZoom.y = game.height / 2 - 50),
                        (e.foulWindow.x = game.width / 2 + 25),
                        (e.foulWindow.y = game.height / 2),
                        (e.quitButton2.y = 250),
                        (e.replayButton.y = 250);
                } else {
                    (e.landscape = !0),
                        ...
                        projectInfo.tutorial &&
                            ((e.skipText.x = game.world.centerX),
                            (e.skipText.y = game.world.centerY + 230),
                            (e.tutorialText.x = game.world.centerX),
                            (e.tutorialText.y = game.world.centerY - 320),
                            game.device.touch &&
                                ((e.hand.scale.x = 1),
                                (e.hand.scale.y = 1),
                                e.tutStage >= 6 &&
                                    ((e.hand.angle = 180),
                                    (e.pointerStart = e.pointerStartL),
                                    (e.pointerEnd = e.pointerEndL)),
                                (6 != e.tutStage && 7 != e.tutStage) ||
                                    ((e.hand.x = e.pointerStart.x), (e.hand.y = e.pointerStart.y)),
                                e.tutStage >= 8 &&
                                    ((e.hand.x = e.pointerStart.x - e.pointerProgress),
                                    (e.hand.y = e.pointerStart.y),
                                    (e.powerBarMask.y = 0),
                                    (e.powerBarMask.x = -e.pointerProgress)))),
                        (e.rackSolids.x = game.width / 4),
                        (e.rackSolids.y = game.height - 40),
                        (e.rackStripes.x = (3 * game.width) / 4),
                        (e.rackStripes.y = game.height - 40),
                        "SOLIDS" == e.p1TargetType &&
                            ((e.rackSolids.x = game.width / 4), (e.rackStripes.x = (3 * game.width) / 4)),
                        "STRIPES" == e.p1TargetType &&
                            ((e.rackSolids.x = (3 * game.width) / 4), (e.rackStripes.x = game.width / 4)),
                        ...
                        (e.humanIcon.scale = new Point(0.4, 0.4)),
                        (e.aiIcon.x = game.width - 120 - e.aiIcon.width),
                        (e.aiIcon.y = game.height - 20),
                        (e.aiIcon.anchor = new Point(0, 1)),
                        (e.aiIcon.scale = new Point(0.4, 0.4)),
                        (e.turnArrow1.x = 75),
                        ...
                        (e.menuButton.y = 20),
                        (e.menuButton.scale = new Point(0.5, 0.5)),
                        ...
                        game.device.touch &&
                            ...
                            e.powerBarMask.beginFill(16711680),
                            e.powerBarMask.drawRect(e.powerBar.x - 26, e.powerBar.y - 750, 26, 500)),
                        (e.successIcon.angle = 0),
                        (e.gameOverPanel.x = game.width / 2),
                        (e.gameOverPanel.y = game.height / 2 - 10 - 75),
                        (e.gameOverPanelBG.angle = 0),
                        (e.GOhighScoreIcon.x = 220),
                        (e.GOhighScoreIcon.y = -246),
                        (e.gameOverPanel.text2.x = 285),
                        (e.gameOverPanel.text2.y = -249),
                        (e.playerWin.x = -400),
                        (e.playerWin.y = -265),
                        (e.popUpPanel.x = game.width / 2),
                        (e.popUpPanel.y = game.height / 2 - 75),
                        (e.popUpPanelBG.angle = 0);
                    let a = famobi.hasFeature("external_mute");
                    (e.playButtonPU.x = 0),
                        (e.playButtonPU.y = -90),
                        ...
                        (e.quitButtonPU.x = a ? 85 : 170),
                        (e.quitButtonPU.y = 130),
                        (e.foulWindow.x = game.width / 2),
                        (e.foulWindow.y = game.height / 2 - 75),
                        (e.quitButton2.y = 170),
                        (e.replayButton.y = 170);
                }
        ...
        function r() {
            game.add.tween(e.guiCanvas).to({ alpha: 0 }, 1e3, Phaser.Easing.Linear.None, !0),
                game.add.tween(e.guiBaseCanvas).to({ alpha: 0 }, 1e3, Phaser.Easing.Linear.None, !0);
            game.add
                .tween(e.gameCanvas)
                ...
                .onComplete.add(function () {
                    ...
                    window.famobi_analytics
                        .trackEvent("EVENT_LEVELFAIL", { levelName: projectInfo.levelName, reason: "quit" })
                        .then(
                            function () {
        ...
        (e.adjustmentScale = 2.3),
            ...
            (function () {
                (e.pockets = new Phaser.Sprite(game, 0, 0, "pockets")),
                    (e.pockets.anchor = new Phaser.Point(0.5, 0.5)),
                    ...
                    (e.cloth.anchor = new Phaser.Point(0.5, 0.5)),
                    ...
                    (e.tableTop.anchor = new Phaser.Point(0.5, 0.5)),
                    e.tableCanvas.add(e.tableTop);
                var a,
                    t,
                    n = 600 * e.adjustmentScale;
                (e.pocketArray = new Array()),
                    (e.vertexArray = new Array()),
                    (e.lineArray = new Array()),
                    ((t = new Object()).position = new Vector2D(
                        -50 * n - e.pocketRadius / 2,
                        -25 * n - e.pocketRadius / 4
                    )),
                    (t.dropPosition = new Vector2D(-51 * n - e.pocketRadius / 2, -26 * n - e.pocketRadius / 4)),
                    (t.starPosition = new Vector2D(-50.4 * n - e.pocketRadius / 2, -25.8 * n - e.pocketRadius / 4)),
                    (t.id = 0),
                    e.pocketArray.push(t),
                    ((t = new Object()).position = new Vector2D(0 * n, -25 * n - e.pocketRadius)),
                    (t.dropPosition = new Vector2D(0 * n, -25.5 * n - e.pocketRadius)),
                    (t.starPosition = new Vector2D(-0.2 * n, -25.5 * n - e.pocketRadius)),
                    (t.id = 1),
                    e.pocketArray.push(t),
                    ((t = new Object()).position = new Vector2D(
                        50 * n + e.pocketRadius / 2,
                    ...
                    (t.dropPosition = new Vector2D(51 * n + e.pocketRadius / 2, -26 * n - e.pocketRadius / 4)),
                    (t.starPosition = new Vector2D(50 * n + e.pocketRadius / 2, -26 * n - e.pocketRadius / 4)),
                    (t.id = 2),
                    e.pocketArray.push(t),
                    ((t = new Object()).position = new Vector2D(
                        -50 * n - e.pocketRadius / 2,
                    ...
                    (t.dropPosition = new Vector2D(-51 * n - e.pocketRadius / 2, 26 * n + e.pocketRadius / 4)),
                    (t.starPosition = new Vector2D(-50.3 * n - e.pocketRadius / 2, 25.5 * n + e.pocketRadius / 4)),
                    (t.id = 3),
                    e.pocketArray.push(t),
                    ((t = new Object()).position = new Vector2D(0 * n, 25 * n + e.pocketRadius)),
                    (t.dropPosition = new Vector2D(0 * n, 25.5 * n + e.pocketRadius)),
                    (t.starPosition = new Vector2D(-0.2 * n, 25.3 * n + e.pocketRadius)),
                    (t.id = 4),
                    e.pocketArray.push(t),
                    ((t = new Object()).position = new Vector2D(
                        50 * n + e.pocketRadius / 2,
                    ...
                    (t.dropPosition = new Vector2D(51 * n + e.pocketRadius / 2, 26 * n + e.pocketRadius / 4)),
                    (t.starPosition = new Vector2D(50 * n + e.pocketRadius / 2, 27 * n - e.pocketRadius / 4)),
                    (t.id = 5),
                    e.pocketArray.push(t);
                ((o = new Object()).name = "AB"),
                    (o.p1 = new Vector2D(-50 * n, -29 * n)),
                    (o.p2 = new Vector2D(-46 * n, -25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "B"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "BC"),
                    (o.p1 = new Vector2D(-46 * n, -25 * n)),
                    (o.p2 = new Vector2D(-4 * n, -25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "C"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "CD"),
                    (o.p1 = new Vector2D(-4 * n, -25 * n)),
                    (o.p2 = new Vector2D(-2 * n, -29 * n)),
                    e.lineArray.push(o),
                    ((o = new Object()).name = "EF"),
                    (o.p1 = new Vector2D(2 * n, -29 * n)),
                    (o.p2 = new Vector2D(4 * n, -25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "F"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "FG"),
                    (o.p1 = new Vector2D(4 * n, -25 * n)),
                    (o.p2 = new Vector2D(46 * n, -25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "G"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "GH"),
                    (o.p1 = new Vector2D(46 * n, -25 * n)),
                    (o.p2 = new Vector2D(50 * n, -29 * n)),
                    e.lineArray.push(o),
                    ((o = new Object()).name = "IJ"),
                    (o.p1 = new Vector2D(54 * n, -25 * n)),
                    (o.p2 = new Vector2D(50 * n, -21 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "J"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "JK"),
                    (o.p1 = new Vector2D(50 * n, -21 * n)),
                    (o.p2 = new Vector2D(50 * n, 21 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    (a.name = "K"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "KL"),
                    (o.p1 = new Vector2D(50 * n, 21 * n)),
                    (o.p2 = new Vector2D(54 * n, 25 * n)),
                    e.lineArray.push(o),
                    ((o = new Object()).name = "MN"),
                    (o.p1 = new Vector2D(50 * n, 29 * n)),
                    (o.p2 = new Vector2D(46 * n, 25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    ...
                    (a.name = "O"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "OP"),
                    (o.p1 = new Vector2D(4 * n, 25 * n)),
                    (o.p2 = new Vector2D(2 * n, 29 * n)),
                    e.lineArray.push(o),
                    ((o = new Object()).name = "QR"),
                    (o.p1 = new Vector2D(-2 * n, 29 * n)),
                    (o.p2 = new Vector2D(-4 * n, 25 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                    ...
                    (a.name = "S"),
                    e.vertexArray.push(a),
                    ((o = new Object()).name = "ST"),
                    (o.p1 = new Vector2D(-46 * n, 25 * n)),
                    (o.p2 = new Vector2D(-50 * n, 29 * n)),
                    e.lineArray.push(o),
                    ((o = new Object()).name = "UV"),
                    (o.p1 = new Vector2D(-54 * n, 25 * n)),
                    (o.p2 = new Vector2D(-50 * n, 21 * n)),
                    e.lineArray.push(o),
                    ((a = new Object()).position = new Vector2D(o.p2.x, o.p2.y)),
                ...
                for (var r = 0; r < e.lineArray.length; r++) {
                    var o;
                    ((o = e.lineArray[r]).direction = new Vector2D(o.p2.x - o.p1.x, o.p2.y - o.p1.y).normalize()),
                        (o.normal = o.direction.getLeftNormal());
                    var i = o.normal.times(e.ballRadius);
                    (o.p3 = o.p1.plus(i)), (o.p4 = o.p2.plus(i));
                    var s = o.normal.times(0.8 * e.ballRadius);
            ...
            (function () {
                ...
                for (var t = 0; t < e.numBalls; t++) {
                    ...
                    switch (
                        ...
                        (n.shadow.anchor = new Point(0.5, 0.5)),
                        ...
                        (n.marker.anchor = new Point(0.5, 0.5)),
                        n.marker.animations.add(
                            "markerAnim",
                    ...
                    (n.mc = new Ball(e.ballRadius * e.physScale, t)),
                        ...
                        0 == t &&
                            ...
                            (n.mover.anchor = new Point(0.5, 0.5)),
                            (n.mover.inputEnabled = !0),
                            (n.mover.visible = !1)),
                        t < 8 && 0 != t && (n.targetType = "SOLIDS"),
                        t > 8 && (n.targetType = "STRIPES"),
                        8 == t && (n.targetType = "8 BALL"),
                        ...
                        0 == t && ((n.screw = 0), (n.english = 0), (n.deltaScrew = new Vector2D(0, 0))),
                        (n.grip = 1),
                        (n.ySpin = 0),
            ...
            (function () {
                (e.debugText = new Phaser.BitmapText(game, game.width - 1, 20, "font7", "", 34)),
                    ...
                    (e.spinSetter.anchor = new Point(0.5, 0.5)),
                    ...
                    (e.cueBallSpotZoom.anchor = new Point(0.5, 0.5)),
                    ...
                    (e.rackBGSolids.x = 1),
                    (e.rackBGSolids.y = 0),
                    (e.rackBGSolids.anchor = new Point(0.5, 1)),
                ...
                (e.rackSolids8ball = new Phaser.Sprite(game, 0, 0, "8ball")),
                    ...
                    (e.rackBGStripes.x = 1),
                    (e.rackBGStripes.y = 0),
                    (e.rackBGStripes.anchor = new Point(0.5, 1)),
                ...
                if (
                    ...
                    (e.turnArrow1.anchor = new Point(0.5, 1)),
                    (e.turnArrow1.scale = new Point(0.5, 0.5)),
                    (e.turnArrow2 = new Phaser.Sprite(game, 0, 0, "turnArrow")),
                    e.guiCanvas.addChild(e.turnArrow2),
                    (e.turnArrow2.anchor = new Point(0.5, 1)),
                    (e.turnArrow2.scale = new Point(-0.5, 0.5)),
                    (e.humanIcon = new Phaser.Sprite(game, 0, 0, "humanIcon")),
                    2 == projectInfo.mode)
                ) {
                    ((l = new Phaser.BitmapText(game, 124, -(e.humanIcon.height - 204), "font7", "1", 80)).anchor =
                ...
                if (
                    ...
                    (e.humanIcon.anchor = new Point(0, 1)),
                    (e.humanIcon.scale = new Point(0.5, 0.5)),
                    1 == projectInfo.mode)
                )
                    e.aiIcon = new Phaser.Sprite(game, 0, 0, "aiIcon");
                else {
                    (e.aiIcon = new Phaser.Sprite(game, 0, 0, "humanIcon")),
                        ((c = new Phaser.BitmapText(game, 124, -(e.humanIcon.height - 81), "font7", "2", 80)).anchor =
                            new Phaser.Point(0.5, 0.5)),
                        (c.tint = 0),
                        e.aiIcon.addChild(c);
                }
                e.guiCanvas.addChild(e.aiIcon),
                    ...
                    (e.aiIcon.scale = new Point(0.5, 0.5)),
                ...
                (e.gameOverPanel = new Phaser.Group(game, e.guiCanvas, "gameOverPanel")),
                    (e.gameOverPanel.anchor = new Point(0.5, 0.5)),
                    (e.gameOverPanel.visible = !1),
                    (e.gameOverPanelBG = new Phaser.Sprite(game, 0, 0, "panel3")),
                    (e.gameOverPanelBG.anchor = new Point(0.5, 0.5)),
                    e.gameOverPanel.addChild(e.gameOverPanelBG),
                    (e.gameOverWindow = new Phaser.Sprite(game, -180, -201, "guiPanel2")),
                    e.gameOverPanel.addChild(e.gameOverWindow),
                    (e.aiWin = new Phaser.Sprite(game, 0, 0, "aiWin")),
                    (e.aiWin.scale = new Phaser.Point(0.5, 0.5)),
                    (e.aiWin.anchor = new Phaser.Point(0.6, 0.6)),
                    e.gameOverPanel.addChild(e.aiWin),
                    (e.aiWin.visible = !1),
                    (e.playerWin = new Phaser.Sprite(game, 0, 0, "playerWin")),
                    (e.playerWin.scale = new Phaser.Point(0.5, 0.5)),
                    (e.playerWin.anchor = new Phaser.Point(0, 0)),
                    e.gameOverPanel.addChild(e.playerWin),
                    (e.playerWin.visible = !1),
                    (e.GOscoreIcon = new Phaser.Sprite(game, -78, -180, "score")),
                    (e.GOscoreIcon.anchor = new Phaser.Point(0.5, 0.1)),
                    (e.GOscoreIcon.scale = new Phaser.Point(0.45, 0.45)),
                    e.gameOverPanel.addChild(e.GOscoreIcon),
                    (e.GOhighScoreIcon = new Phaser.Sprite(game, 270, -256, "highScore")),
                    (e.GOhighScoreIcon.anchor = new Phaser.Point(0.5, 0.25)),
                    (e.GOhighScoreIcon.scale = new Phaser.Point(0.5, 0.5)),
                    e.gameOverPanel.addChild(e.GOhighScoreIcon),
                    (e.GOaiLevel = new Phaser.Sprite(game, 70, -5, "aiLevel")),
                    (e.GOaiLevel.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.GOaiLevel.scale = new Phaser.Point(0.8, 0.8)),
                    e.gameOverPanel.addChild(e.GOaiLevel),
                    (e.GOclockIcon = new Phaser.Sprite(game, -180, -5, "clockIcon")),
                    (e.GOclockIcon.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.GOclockIcon.scale = new Phaser.Point(0.55, 0.55)),
                    e.gameOverPanel.addChild(e.GOclockIcon);
                let s = { x: -140, y: -120 };
                var l;
                (e.p1Icon = new Phaser.Sprite(game, s.x, s.y, "humanIcon")),
                    (e.p1Icon.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.p1Icon.scale = new Phaser.Point(0.5, 0.5)),
                    e.gameOverPanel.addChild(e.p1Icon),
                    ((l = new Phaser.BitmapText(game, -4, 81, "font7", "1", 80)).anchor = new Phaser.Point(0.5, 0.5)),
                    (l.tint = 0),
                    e.p1Icon.addChild(l),
                    ((u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor = new Phaser.Point(0.5, 0.5)),
                    (u.scale = new Phaser.Point(1, 1)),
                    e.p1Icon.addChild(u),
                    (e.p1Icon.rosette = u),
                    (e.p1Icon.visible = !1);
                let p = { x: 140, y: -120 };
                var c, u;
                (e.p2Icon = new Phaser.Sprite(game, p.x, p.y, "humanIcon")),
                    (e.p2Icon.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.p2Icon.scale = new Phaser.Point(0.5, 0.5)),
                    e.gameOverPanel.addChild(e.p2Icon),
                    ((c = new Phaser.BitmapText(game, -4, 81, "font7", "2", 80)).anchor = new Phaser.Point(0.5, 0.5)),
                    (c.tint = 0),
                    e.p2Icon.addChild(c),
                    ((u = new Phaser.Sprite(game, -128, -128, "rosette")).anchor = new Phaser.Point(0.5, 0.5)),
                    (u.scale = new Phaser.Point(1, 1)),
                    ...
                    (e.p2Icon.rosette = u),
                    (e.p2Icon.visible = !1),
                    (e.gameOverPanel.text1 = new Phaser.BitmapText(game, 0, -180, "font7", "xxx", 56)),
                    (e.gameOverPanel.text2 = new Phaser.BitmapText(game, 0, -209, "font7", "xxx", 56)),
                    (e.gameOverPanel.text3 = new Phaser.BitmapText(game, -110, -28, "font7", "xxx", 56)),
                    (e.gameOverPanel.text4 = new Phaser.BitmapText(game, 135, -28, "font7", "xxx", 56)),
                    e.gameOverPanel.addChild(e.gameOverPanel.text1),
                    e.gameOverPanel.addChild(e.gameOverPanel.text2),
                    e.gameOverPanel.addChild(e.gameOverPanel.text3),
                    e.gameOverPanel.addChild(e.gameOverPanel.text4);
                (e.quitButton2 = new Phaser.Button(game, 90, 170, "quitButton", r, this, 1, 0, 1)),
                    (e.quitButton2.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.quitButton2.scale = new Phaser.Point(0.5, 0.5)),
                    e.gameOverPanel.addChild(e.quitButton2),
                    (e.replayButton = new Phaser.Button(game, -90, 170, "replayButton", o, this, 1, 0, 1)),
                    (e.replayButton.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.replayButton.scale = new Phaser.Point(0.5, 0.5)),
                    ...
                    (e.popUpPanelBG.scale = new Point(0.75, 1)),
                    (e.popUpPanelBG.anchor = new Point(0.5, 0.5)),
                    e.popUpPanel.addChild(e.popUpPanelBG),
                    (e.playButtonPU = new Phaser.Button(game, 0, 0, "playButton", a, this, 1, 0, 1, 0)),
                    (e.playButtonPU.scale = new Point(0.75, 0.75)),
                    e.popUpPanel.addChild(e.playButtonPU),
                    (e.playButtonPU.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.quitButtonPU = new Phaser.Button(game, -57, 0, "quitButton", r, this, 1, 0, 1, 0)),
                    e.popUpPanel.addChild(e.quitButtonPU),
                    (e.quitButtonPU.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.quitButtonPU.scale = new Phaser.Point(0.5, 0.5)),
                    (e.replayButtonPU = new Phaser.Button(game, -170, 0, "replayButton", o, this, 1, 0, 1, 0)),
                    e.popUpPanel.addChild(e.replayButtonPU),
                    (e.replayButtonPU.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.replayButtonPU.scale = new Phaser.Point(0.5, 0.5)),
                    (e.muteButtonPU = new Phaser.Button(game, 57, 0, "muteButton", t, this, 1, 0, 1, 0)),
                    e.popUpPanel.addChild(e.muteButtonPU),
                    (e.muteButtonPU.anchor = new Phaser.Point(0.5, 0.5)),
                    (e.muteButtonPU.scale = new Phaser.Point(0.5, 0.5)),
                    1 == Sound.slave ? e.muteButtonPU.setFrames(1, 0, 1, 0) : e.muteButtonPU.setFrames(3, 2, 3, 2);
                (e.quitButtonPU.input.enabled = !1),
                    ...
                    (e.muteButtonPU.visible = !famobi.hasFeature("external_mute")),
                    ...
                    (e.foulWindow.background.anchor = new Point(0.5, 0.5)),
                    (e.foulWindow.display1 = new Phaser.Sprite(game, -172, -126, "illegalContacts")),
                    e.foulWindow.addChild(e.foulWindow.display1);
                var h = new Phaser.Sprite(
                    game,
                    e.foulWindow.display1.width / 2,
                    e.foulWindow.display1.height / 2 + 20,
                    "cross"
                );
                (h.anchor = new Point(0.5, 0)),
                    e.foulWindow.display1.addChild(h),
                    (e.foulWindow.display2 = new Phaser.Sprite(game, -172, 30, "illegalContacts")),
                    e.foulWindow.addChild(e.foulWindow.display2);
                var d = new Phaser.Sprite(
                    game,
                    e.foulWindow.display2.width / 2,
                    e.foulWindow.display2.height / 2 + 20,
                    "tick"
                );
                (d.anchor = new Point(0.5, 0)),
                    e.foulWindow.display2.addChild(d),
                    (e.foulWindow.display3 = new Phaser.Sprite(game, 0, 0, "illegalShots")),
                    e.foulWindow.addChild(e.foulWindow.display3),
                    (e.foulWindow.display3.anchor = new Point(0.5, 0.5)),
                    (e.foulWindow.display4 = new Phaser.Sprite(game, 0, 0, "illegalBreak")),
                    e.foulWindow.addChild(e.foulWindow.display4),
                    (e.foulWindow.display4.anchor = new Point(0.5, 0.5)),
                    (e.foulWindow.highlight = new Phaser.Sprite(game, -262, -237, "foulHighlight")),
                    e.foulWindow.addChild(e.foulWindow.highlight),
                    1 == projectInfo.tutorial &&
                        (game.device.touch,
                        (e.menuButton.visible = !1),
                        (e.turnArrow1.visible = !1),
                        (e.turnArrow2.visible = !1),
                        (e.humanIcon.visible = !1),
                        (e.aiIcon.visible = !1),
                        (e.rackSolids.visible = !1),
                        (e.rackStripes.visible = !1),
                        (e.spinSetter.visible = !1));
            })(),
            ...
            (function () {
                (e.levelText = new Phaser.BitmapText(game, 0, -100, "font1", projectInfo.level, 48)),
                    ...
                    (e.levelText.anchor.x = 0.5),
                    (e.levelText.anchor.y = 0.5),
                    (e.levelText.alpha = 0.2),
                    (e.successIcon = new Phaser.Sprite(game, 0, 0, "success")),
                    e.timerCanvas.addChild(e.successIcon),
                    (e.successIcon.visible = !1),
                    (e.successIcon.anchor = new Point(0.5, 0.5)),
                    (e.successIcon.alpha = 0.25),
                    1 == projectInfo.tutorial && (e.levelText.visible = !1);
            ...
            1 == projectInfo.tutorial &&
                (game.device.touch
                    ...
                    : ((e.mouseSprite = new Phaser.Sprite(game, 0, 0, "mouseSprite")),
                      ...
                      (e.mouseSprite.anchor = new Point(1, -0.5)))),
            "none" == projectInfo.lastBreaker
                ? Math.random() < 0.5
                    ? ((e.turn = "p1"), (e.turnArrow1.frame = 1), (e.turnArrow2.frame = 0))
                    : ((e.turn = "p2"), (e.turnArrow1.frame = 0), (e.turnArrow2.frame = 1))
                : "p2" == projectInfo.lastBreaker
                  ? ((e.turn = "p1"), (e.turnArrow1.frame = 1), (e.turnArrow2.frame = 0))
                  : ((e.turn = "p2"), (e.turnArrow1.frame = 0), (e.turnArrow2.frame = 1)),
            (function () {
                (e.skipText = new Phaser.BitmapText(
                    game,
                    game.world.centerX,
                    ...
                    (e.skipText.anchor.x = 0.5),
                    (e.skipText.anchor.y = 0.5),
                    (e.skipText.alpha = 0.8),
                    projectInfo.tutorial && (e.skipText.visible = !0);
                e.skipText.visible = !1;
            })(),
            (function () {
                (e.tutorialText = new Phaser.BitmapText(game, 0, 0, "font3", "Tutorial", 78)),
                    e.guiCanvas.addChild(e.tutorialText),
                    (e.tutorialText.anchor.x = 0.5),
                    (e.tutorialText.anchor.y = 0.5),
                    (e.tutorialText.alpha = 0.8),
                    projectInfo.tutorial && (e.tutorialText.visible = !0);
    ...
    (playState.resumeGame = function () {
        var e = this.gameInfo;
        1 != e.gameOver && (window.famobi_analytics.trackScreen("SCREEN_LEVEL"), (e.gameRunning = !0)),
            (e.popUpPanel.visible = !1),
            (e.quitButtonPU.input.enabled = !1),
            (e.replayButtonPU.input.enabled = !1),
            (e.playButtonPU.input.enabled = !1),
