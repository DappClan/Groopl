...
<template>
  <DialogPortal>
    <DialogOverlay
      class="bg-black/80 inset-0 fixed z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0"
    />
    <DialogContent
      v-bind="forwarded"
      :class="
