  ...
  shortcuts: [
    {
      ...
      'btn-solid': 'btn-base px-4 py-2 rounded-md text-inverted bg-$c-primary hover:bg-$c-primary-active',
    ...
    [/^groopl-group-hover[:-]([a-z0-9/-]+)$/, ([,r]) => `media-mouse-group-hover-${r} group-active-${r}`],
  ],
  presets: [
    presetUno({
